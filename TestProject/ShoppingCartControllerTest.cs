...
namespace TestProject
{
    public class ShoppingCartControllerTest
    {
        ...
        private async void ShoppingCartProductTotalCorrect()
        {
            //Arrange - Creates database, repository and shopping cart needed by the Controller.
            CreateMockDB();
            CreateRepo();
            ...
            //Assert - testTotal should == correctTotal to pass.
